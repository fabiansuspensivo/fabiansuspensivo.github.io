    ...
    series: {
      'flotilla': {
        ...
        historia: [
          ...
          'Volví durante semanas y acabé conociendo los barcos por dentro. Las literas donde se dormía, la cocina estrecha, la mesa donde se comía de pie. Llegaba gente de fuera que no se conocía entre sí y que a los tres días ya discutía en asambleas de horas. Los críos del barrio pintaron barcos y sandías en una pared del muelle. Alguien subió a lo alto del mástil a colgar banderas.',
    ...
    series: {
      'flotilla': {
        ...
        historia: [
          ...
          'Hi vaig tornar durant setmanes i vaig acabar coneixent els vaixells per dins. Les lliteres on es dormia, la cuina estreta, la taula on es menjava dret. Arribava gent de fora que no es coneixia entre ella i que al cap de tres dies ja discutia en assemblees d\u2019hores. La canalla del barri va pintar vaixells i síndries en una paret del moll. Algú va pujar dalt del pal a penjar banderes.',
