  ...
  es: {
    ...
    series: {
      'ni-gent-sense-casa': {
        ...
        subtitulo:
          'Quién está vaciando Barcelona. Seis desahucios desde enero de 2025, en seis barrios.',
        ...
        resumen:
          'El título es la consigna que se corea en las puertas. Detrás de estos desahucios no hay historias sueltas: hay tres empresas haciendo lo mismo, comprar el edificio entero, vaciarlo y multiplicar la renta. Y un ayuntamiento haciéndolo por su cuenta.',
        historia: [
  ...
  ca: {
    ...
    series: {
      'ni-gent-sense-casa': {
        titulo: 'Ni gent sense casa ni casa sense gent',
        subtitulo:
          'Qui està buidant Barcelona. Sis desnonaments des del gener de 2025, a sis barris.',
        ...
        resumen:
          'El títol és la consigna que es crida a les portes. Darrere d’aquests desnonaments no hi ha històries soltes: hi ha tres empreses fent el mateix, comprar l’edifici sencer, buidar-lo i multiplicar la renda. I un ajuntament fent-ho pel seu compte.',
        historia: [
  ...
  de: {
    ...
    series: {
      'ni-gent-sense-casa': {
        titulo: 'Ni gent sense casa ni casa sense gent',
        subtitulo:
          'Wer Barcelona leerräumt. Sechs Zwangsräumungen seit Januar 2025, in sechs Vierteln.',
        ...
        resumen:
          'Der Titel ist die Parole, die vor den Haustüren gerufen wird. Hinter diesen Räumungen stehen keine Einzelschicksale, sondern drei Firmen mit demselben Vorgehen: das ganze Haus kaufen, es leerräumen und die Miete vervielfachen. Und eine Stadtverwaltung, die es auf eigene Rechnung tut.',
        historia: [
